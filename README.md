...
| **[LittleVisions](https://github.com/newtvn/littlevisions)** | AI-powered storytelling for children. <br>🎨 *Blends GPT with child-safe UX flows* | `OpenAI`, `Python`, `Figma` |
...
**Backend**  
`Node.js` · `Django` · `PHP` · `GraphQL` · `JWT` · `REST APIs`

**Databases**  
`PostgreSQL` · `MongoDB` · `Neo4j` · `Firebase`

**DevOps**  
`Docker` · `GitHub Actions` · `AWS EC2` · `Nginx` · `Digital Ocean`

**Tools**  
`Postman` · `VS Code` · `Lucidchart` · `Draw.io` · `Sublime Text`
...
<p align="center">
  ...
  <a href="https://linkedin.com/in/newtvn"><img src="https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white" /></a>
  <a href="https://twitter.com/newtvn"><img src="https://img.shields.io/badge/Twitter-1DA1F2?style=for-the-badge&logo=twitter&logoColor=white" /></a>
  <a href="https://dev.to/newtvn"><img src="https://img.shields.io/badge/DEV.to-0A0A0A?style=for-the-badge&logo=devdotto&logoColor=white" /></a>
</p>
